    ...
    <div className="bg-black text-white min-h-screen overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full z-40 border-b border-purple-500/20 bg-black/80 backdrop-blur-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          >
            <span className="text-purple-500">Malshan</span>Portfolio
            <motion.div
            ...
            <ul className="flex space-x-1">
              {navLinks.map((item, index) => (
                ...
                >
                  ...
                  >
                    <span
                      className={`relative z-10 ${activeSection === item.name.toLowerCase()
                          ? "text-purple-300"
      ...
      >
        ...
        <motion.div style={{ y: y1, opacity: opacity1 }} className="absolute top-0 left-0 w-full h-full z-0">
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            <motion.h1 className="text-4xl md:text-7xl font-bold mb-6">
              Creative <span className="text-purple-500">Front-End</span> Developer
            </motion.h1>
            ...
            >
              <Button
                ...
                onClick={() => scrollToSection(projectsRef as React.RefObject<HTMLDivElement>)}
              >
      ...
      {/* About Section */}
      <section id="about" ref={aboutRef} className="min-h-screen flex items-center justify-center relative py-20">
        <motion.div style={{ y: y2 }} className="absolute top-0 left-0 w-full h-full z-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            >
              <div className="w-full h-[400px] relative rounded-lg overflow-hidden">
                <Image src="/me.jpg?height=800&width=600" alt="Developer" fill className="object-cover" />
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                I'm Malshan, a passionate front-end developer with a keen eye for design and a love for creating seamless user
                experiences. With expertise in modern frameworks and libraries, I build responsive, accessible, and
              ...
              <p className="text-gray-300 mb-8">
                ...
                work on not only meets but exceeds expectations. I'm constantly learning and exploring new technologies
                to stay at the forefront of web development.
              </p>
              <div className="flex flex-wrap gap-4">
                <div className="bg-gray-800 px-4 py-2 rounded-full">
                  <span className="text-purple-500 font-medium">2+</span> Years Experience
                </div>
                <div className="bg-gray-800 px-4 py-2 rounded-full">
                  <span className="text-purple-500 font-medium">20+</span> Projects Completed
                </div>
                <div className="bg-gray-800 px-4 py-2 rounded-full">
                  <span className="text-purple-500 font-medium">10+</span> Happy Clients
                </div>
              </div>
            </motion.div>
          </div>
      ...
      {/* Skills Section */}
      <section id="skills" ref={skillsRef} className="min-h-screen flex items-center justify-center relative py-20">
        <motion.div style={{ y: y3 }} className="absolute top-0 left-0 w-full h-full z-0">
      ...
      {/* Projects Section */}
      <section id="projects" ref={projectsRef} className="min-h-screen flex items-center justify-center relative py-20">
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              A selection of my recent work, showcasing my skills in front-end development, UI/UX design, and creative
              problem-solving.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "A sophisticated e-commerce platform featuring seamless cart functionality, secure payment integration, and a user-friendly interface designed to enhance the shopping experience.",
                image: "e-commerce.png?height=600&width=800",
                tags: ["React", "Next.js", "Tailwind CSS", "Stripe", "Firebase"],
                link: "https://github.com/Malshan20/Mezzo.git"
              },
              {
                title: "Portfolio",
              ...
              },
              {
                ...
                description: "A comprehensive platform for e-sports tournaments, featuring real-time live streaming, interactive leaderboards, and detailed match statistics.",
                image: "/e-sport.png?height=600&width=800",
                tags: ["React", "TypeScript", "Chart.js", "Socket.io"],
                link: "https://github.com/Malshan20/nexus.git"
              },
              {
                title: "Gamified Learning App",
                description: "A mobile application designed to enhance student engagement through gamification, offering interactive lessons, rewards, and progress tracking.",
                image: "/gamified.png?height=600&width=800",
                tags: ["React Native", "Redux", "Styled Components", "Expo"],
                link: "https://github.com/Malshan20/gamifyed.git"
              },
              {
                title: "SaaS Product Landing Page",
                description: "A visually appealing and high-converting landing page for a SaaS product, utilizing animations and clear calls-to-action to drive user engagement and conversions.",
                image: "/landing.png?height=600&width=800",
                tags: ["HTML", "CSS", "JavaScript", "GSAP", "AOS"],
                link: "https://github.com/Malshan20/AI-NEW.git"
              },
              {
                title: "Twitchie - Video Sharing Platform",
                description: "A full-stack application that allows users to create, share, and discover short video clips, similar to YouTube, with a focus on community engagement and content discovery.with payment integration.",
                image: "/twitchie.png?height=600&width=800",
                tags: ["PHP", "HTML", "CSS", "Tailwind CSS", "JavaScript", "MySQL"],
                link: "https://github.com/Malshan20/twitchie.git"
              },
            ].map((project, index) => (
              <motion.div
                key={project.title}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Button variant="ghost" className="text-purple-500 hover:text-purple-400 p-0" asChild>
          ...
          >
            <Button size="lg" className="bg-purple-600 hover:bg-purple-700">
              <a href="http://github.com/Malshan20" target="_blank" rel="noopener noreferrer">
              View All Projects
              </a>
            </Button>
          </motion.div>
      ...
      {/* Contact Section */}
      <section id="contact" ref={contactRef} className="min-h-screen flex items-center justify-center relative py-20">
        <motion.div className="absolute top-0 left-0 w-full h-full z-0">
          <div className="absolute top-20 left-20 w-64 h-64 rounded-full bg-purple-500/20 blur-3xl" />
          <div className="absolute bottom-40 right-20 w-80 h-80 rounded-full bg-blue-500/20 blur-3xl" />
        </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">malshandissanayaka246@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">https://malshandissanayaka.vercel.app</p>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-gray-900/80 backdrop-blur-sm py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              © {new Date().getFullYear()} MalshanPortfolio. All rights reserved.
            </motion.div>
          </div>
        </div>
      </footer>
